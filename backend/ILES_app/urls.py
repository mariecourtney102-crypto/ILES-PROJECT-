...
urlpatterns = [
    ...
    path('user/role/', views.update_user_role, name='update_user_role'),
    ...
    path('weekly-logs/<int:log_id>/delete/', views.delete_weekly_log, name='delete_weekly_log'),
    ...
    path('supervisor/weekly-logs/<int:log_id>/update-status/', views.update_log_status, name='update_log_status'),
